...
public class MessageConstants {
     ...
     */
    public static final Map<Class<? extends Message>, Parser<? extends Message>> MESSAGE_CLASS_TO_PARSER;
    ...
    public static final Map<Class<? extends Message>, Integer> MESSAGE_CLASS_TO_TYPE;

    /**
     * Map of "ServerMessages" type tag to class.
     */
    public static final Map<Integer, Class<? extends Message>> MESSAGE_TYPE_TO_CLASS;
    ...
    static {
         ...
         */
        Map<Class<? extends Message>, Parser<? extends Message>> messageClassToParser = new HashMap<>();
        Map<Class<? extends Message>, Integer> messageClassToType = new HashMap<>();
        Map<Integer, Class<? extends Message>> messageTypeToClass = new HashMap<>();
        ...
        for (Map.Entry<Class<? extends Message>, Integer> entry : messageClassToType.entrySet()) {
    ...
    public static Class<? extends Message> getMessageClassForType(int type) {
        Class<? extends Message> messageClass = MessageConstants.MESSAGE_TYPE_TO_CLASS.get(type);

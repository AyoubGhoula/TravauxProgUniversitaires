...
public class Viennoiserie implements Product,Prototype {
    ...
    public String getName() {
        return NOM_Viennoiserie;  // FIX: Return the actual field
    }
	...
	public Prototype clonePrototype() {
	     return new Viennoiserie(this.NOM_Viennoiserie, this.FO_ID, this.PRIX, this.VENTES);
